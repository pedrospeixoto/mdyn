...
if os.path.exists(proc_file):    
    ...
    for i, city in enumerate(cities):
        ...
        #print(city, city_area, city_covid)
...
#sm.qqplot(y)
#plt.show()
yt, tmp = stats.boxcox(y+shift)
#sm.qqplot(yt)
#plt.show()

#sm.qqplot(z)
#plt.show()
zt, tmp = stats.boxcox(z)
#sm.qqplot(zt)
#plt.show()
...
X=np.column_stack((np.transpose(x), np.transpose(z)))
#X=x
...
#plt.ylabel("sarscov2 2020 acumulated incidence to "+date_ref, fontsize=14)
plt.ylabel("sarscov2 2020 acumulated incidence to "+date_ref, fontsize=14)
