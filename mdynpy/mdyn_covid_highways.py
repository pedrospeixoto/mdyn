...
date = "2020-09-12"
variable =  "last_available_deaths" #
#variable = "last_available_confirmed" #"last_available_deaths" # # last_available_confirmed_per_100k_inhabitants #"last_available_deaths"
