...
set output "metropoleNacionalI.eps"
set encoding utf8
...
set ylabel "{/*1.1{isolation/average group isolation}}"
set xlabel "{/*1.1{date}}"
...
set label '(a)'at 15,1.6
set arrow from 0,1. to 240,1. nohead front ls 10
set title "{/*1.1  National Metropolis}"
plot "metropolesI-difRAZAO.dat" u 1:5 title "{/*1.1{Brasília}}" @a26,\
"metropolesI-difRAZAO.dat" u 1:11 title "{/*1.1{Rio de Janeiro}}" @a28,\
"metropolesI-difRAZAO.dat" u 1:15 title "{/*1.1{São Paulo}}" @a2
