...
source("mdyn/SEIR/initial_condition_corrected_research.R")
source("mdyn/SEIR/obs_around_init_research.R")
...
source("mdyn/SEIR/beta_research.R")
source("mdyn/SEIR/seir_solver.R")
source("mdyn/SEIR/test_model.R")
source("mdyn/SEIR/Rt_research.R")
