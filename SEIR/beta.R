...
beta <- function(parK,t,lambda,drs,day,obs){
  ...
  #Calculate exposed
  parK$obs_DRS$E[[as.character(t)]] <- (1/(parK$gammaI*parK$gammaS))*(parK$obs_DRS$E[[as.character(t+2)]]+
  ...
  parK$obs$E[[as.character(t)]] <- (1/(parK$gammaI*parK$gammaS))*(parK$obs$E[[as.character(t+2)]]+
