...
simulate_length <- as.numeric(ymd("2021-05-31") + 5 - ymd(d_max)) #Number of days to simulate
error_I <- 0.025
error_D <- 0.025

#Set mobility matrix
par$mob <- list()
day <- seq.Date(from = ymd("2020-10-01"),to = ymd("2020-11-08"),1)
...
for(d in as.character(seq.Date(from = ymd("2020-07-27"),to = d_max,1)))
