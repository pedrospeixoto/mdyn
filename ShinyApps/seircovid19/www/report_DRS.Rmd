...
\small Apenas para Municípios com mais de 1,000 casos ou 100 mortes confirmadas em `r format(params$dmin,"%d/%m/%Y")`
...
\noindent Os modelos foram escolhidos dentre dezenas de milhares de modelos candidatos, pois se aderiram bem aos dados observados. A aderência foi mensurada pela diferença entre o número de mortes e o número de casos confirmados nos DRSs e Municípios com mais de 100 mortes ou 1,000 casos, respectivamente, durante a semana terminando em `r params$data`
